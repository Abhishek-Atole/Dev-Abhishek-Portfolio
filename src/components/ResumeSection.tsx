...
const ResumeSection = () => {
  // Fetch work experiences from the database
  const { data: experiences = [], isLoading } = useQuery({
    queryKey: ["work-experiences-public"],
    queryFn: async () => {
  ...
  // Fallback static experiences if database is empty or loading
  ...
  const displayExperiences = experiences.length > 0 ? experiences : staticExperiences;
    ...
    <section id="resume" className="py-16 bg-secondary/30">
      <div className="container mx-auto">
        ...
        <div className="space-y-8">
          ...
          {isLoading ? (
            <div className="text-center py-8">Loading work experiences...</div>
          ) : (
